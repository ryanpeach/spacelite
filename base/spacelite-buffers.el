...
(defun spacelite/init-buffer-keybindings ()
  (spacelite/set-leader-keys
    "bd" 'spacelite/kill-this-buffer
    "b C-d" 'spacelite/kill-other-buffers
    "be" 'spacelite/safe-erase-buffer
    "bn" 'next-buffer
    "bN" 'spacelite/new-empty-buffer
    "bp" 'previous-buffer
    "bY" 'copy-whole-buffer-to-clipboard
    "fs" 'save-buffer
    "fD" 'spacelite/delete-current-buffer-file
    "bR" 'revert-buffer
    )
  )
